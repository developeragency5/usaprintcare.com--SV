        ...
        <Navbar/>
         <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <ul className="list-disc list-inside mb-4">
                ...
                <li>
                    <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to USA PRINT CARE, 1968 S Coast Hwy #3514 Laguna Beach, CA 92651.
                </li>
                <li>
                ...
                <li>
                    <strong>Website</strong> refers to USA PRINT CARE, accessible from <a href="https://www.usaprintcare.com/" rel="external nofollow noopener" target="_blank" className="text-blue-600 underline">https://www.usaprintcare.com/</a>.
                </li>
                <li>
            ...
            <p className="mb-4">If you are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident.</p>
            ...
            <p className="mb-4">These Terms and Conditions may have been translated if we have made them available to you on our Service. You agree that the original English text shall prevail in the case of a dispute.</p>
            ...
            <ul className="list-disc list-inside mb-4">
                ...
                <li>By visiting this page on our website: <a href="https://www.usaprintcare.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">https://www.usaprintcare.com/</a></li>
