...
const Privacy = () => {
  return (
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          "Us" or "Our" in this Agreement) refers to USA PRINT CARE LLC, 1968 S
          Coast Hwy #3514 Laguna Beach, CA 92651.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to USAPRINT CARE, accessible from{" "}
          <a
            href="https://usaprintcare.com"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://usaprintcare.com
          </a>
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>
        <p>By email: usaprintcare@outlook.com</p>
      </li>
      <li>
        <p>
          By visiting this page on our website:{" "}
          <a
            href="https://www.usaprintcare.com"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://www.usaprintcare.com
          </a>
        </p>
      </li>
      <li>
        <p>By phone number: 949 273 2422</p>
      </li>
      <li>
        <p>By mail: 1968 S Coast Hwy #3514 Laguna Beach, CA 92651</p>
      </li>
    </ul>
    <Footer/>
  </>
