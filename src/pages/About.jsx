  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="flex flex-col items-center justify-center w-[80%] mx-auto mt-16">
        ...
        <h1 className="text-4xl font-bold text-[#0075B1] uppercase mb-6">USA PRINT CARE</h1>
      </div>
      ...
      <div className="w-[80%] mx-auto my-10 text-center">
        ...
        <p className="text-lg text-gray-800 mb-4">
          Don’t let printer issues slow you down. Contact us at <strong>866-971-9080</strong> to speak with a support specialist and discover how USA PRINT CARE can assist you with all your printing needs. We are proud to serve our community and look forward to being your trusted partner for <strong>printer service and repair</strong>.
        </p>
      </div>
